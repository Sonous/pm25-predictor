...
- Phương pháp chính: Mô hình đề xuất trong đề tài gồm ba khối chính: CNN1D, BLSTM và Attention, được kết hợp theo hướng tuần tự để tận dụng khả năng trích xuất đặc trưng cục bộ, học phụ thuộc chuỗi và tập trung vào các yếu tố quan trọng của dữ liệu.
